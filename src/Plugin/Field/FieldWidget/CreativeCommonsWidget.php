...
class CreativeCommonsWidget extends WidgetBase implements ContainerFactoryPluginInterface {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $element['cc_id'] = [
      ...
      '#default_value' => $items[$delta]->cc_id ?? NULL,
      '#required' => FALSE,
    ...
    $element['work_title'] = [
      ...
      '#default_value' => $items[$delta]->work_title ?? NULL,
    ...
    $element['work_link'] = [
      ...
      '#default_value' => $items[$delta]->work_link ?? NULL,
      '#size' => $this->getSetting('size'),
      '#maxlength' => $this->getSetting('max_length'),
      '#required' => FALSE,
    ];
    ...
    $element['source_title'] = [
      ...
      '#default_value' => $items[$delta]->source_title ?? NULL,
      '#size' => $this->getSetting('size'),
      '#maxlength' => $this->getSetting('max_length'),
      '#required' => FALSE,
    ];
